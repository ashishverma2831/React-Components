...
const ForgetPassword = () => {
    return (
        <>
            <section style={{ backgroundImage: 'linear-gradient(to right top, #72a5f1, #4dc3eb, #7cd7d4, #bae5c8, #edf0d5)' }} >
                ...
                <div className='h-screen flex justify-center items-center px-2 sm:p-5'>
                    <div className='w-[450px] rounded-2xl mx-auto text-center flex justify-center items-center flex-col gap-2 bg-white p-5 shadow-lg'>
                        <img width={100} className='sm:my-5 my-2 bg-transparent' src='https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcQgByBT5IiAT_a2x9pUVb4VMoOrlzHH7Jrzj-HB5jzHlR4lNLMS' />
                        <p className='text-xl font-medium'>Forget your password?</p>
                        <p className='sm:text-[16px] text-[14px] text-gray-500'>Please enter the email address associated with your account and we'll email you a link to reset your password.</p>
